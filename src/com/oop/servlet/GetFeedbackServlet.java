...
public class GetFeedbackServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Feedback feedback = iFeedbackService.getFeedbackByID(feedbackID);

		request.setAttribute("feedback", feedback);
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/views/GetFeedback.jsp");
