...
/**
 * This load Sql queries available in the ItemQuery.xml
 * @see #CommonUtil
 */
public class QueryUtil extends CommonUtil {
	...
	public static String queryByID(String id) throws SAXException, IOException, ParserConfigurationException {
		 ...
		 */
		nodeList = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File(System.getProperty("catalina.base") + "\\wtpwebapps\\OOPAuctionSystem\\WEB-INF\\ItemQuery.xml"))
